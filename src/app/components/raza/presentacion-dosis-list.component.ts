...
export class PresentacionDosisListComponent implements OnInit {
  ...
  ngOnInit(): void {
	...
	this.getPresentacionDosisList(null);
  ...
  advancedSearch() {
   if (this.queryParamList !== null && this.queryParamList.length > 0) {
     if (this.queryParamList.length === 1 && this.queryParamList[0][0].length === 0) {
       ...
       this.getPresentacionDosisList(this.queryParamList);
     }
   	 } else {
       this.getPresentacionDosisList(null);
     }
  ...
  onSelectedPresentacionDosis(presentacionDosis: PresentacionDosis){
   ...
   getPresentacionDosisList(queryParamList: [string, string][]) {
